...
if (isset($_POST['submit'])) {
    ...
    $add_playlist = $conn->prepare("INSERT INTO `kursus_bayar`(id, tutor_id, title, link, tema, materi, description, thumb, status) VALUES(?,?,?,?,?,?,?,?,?)");
...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="tema" maxlength="100" required placeholder="Masukan Materi yang di bahas" class="box">

      <p>Premium<span>*</span></p>
      <input type="text" name="link" maxlength="100" required placeholder="Premium" class="box">
