...
if(isset($_POST['tutors_fetch'])){

   $tutor_email = $_POST['tutors_email'];
...
<section class="tutor-profile">
   ...
   <h1 class="heading">profile Perusahaan</h1>
   ...
   <div class="details">
      ...
      <div class="flex">
         <p>Lowongan  : <span><?= $total_playlists; ?></span></p>
