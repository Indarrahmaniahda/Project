...
<body>
   ...
   <section class="playlist-details">
      ...
      <?php
      $select_playlist = $conn->prepare("SELECT * FROM `kursus_gratis2` WHERE id = ? AND tutor_id = ?");
      ...
      ?>
            ...
            <div class="details">
                  <div class="title1"> <h3 class="title"><?= $fetch_playlist['title']; ?></h3></div>
                  ...
                  <form action="" method="post" class="flex-btn">
                     ...
                     <a href="update_gratis2.php?get_id=<?= $playlist_id; ?>" class="option-btn">update konten</a>
   ...
   <section class="contents">
      ...
      <div class="box-container">
         ...
         <?php
            ...
            echo '<p class="empty">Tidak ada vidio! <a href="add_con_gratis.php" class="btn" style="margin-top: 1.5rem;">Tambahkan vidio</a></p>';
         }
         ?>
