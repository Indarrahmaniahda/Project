...
<section class="playlist-details">
   ...
   <h1 class="heading">Lowongan detail</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">update konten</a>
...
<section class="contents">
   ...
   <h1 class="heading">Vidio lowongan </h1>
